...
int ff_hevc_decode_nal_pps(HEVCContext *s)
{
    ...
    if (pps->tiles_enabled_flag) {
        ...
        pps->column_width = (uint32_t*)av_malloc_array(pps->num_tile_columns, sizeof(*pps->column_width));
        pps->row_height   = (uint32_t*)av_malloc_array(pps->num_tile_rows,    sizeof(*pps->row_height));
    ...
    // Inferred parameters
    pps->col_bd   = (uint32_t*)av_malloc_array(pps->num_tile_columns + 1, sizeof(*pps->col_bd));
    pps->row_bd   = (uint32_t*)av_malloc_array(pps->num_tile_rows + 1,    sizeof(*pps->row_bd));
    pps->col_idxX = (int32_t*)av_malloc_array(sps->ctb_width,    sizeof(*pps->col_idxX));
